    ...
    public static class PolygonTools
    {
                                                      ...
                                                      int segments)
        {
            ...
            else
            {
                ...
                float stepSize =Microsoft.Xna.Framework.MathHelper.TwoPi / (numberOfEdges - 4);
        ...
        public static Vertices CreateEllipse(float xRadius, float yRadius, int numberOfEdges)
        {
            ...
            float stepSize =Microsoft.Xna.Framework.MathHelper.TwoPi / numberOfEdges;
                                             ...
                                             int bottomEdges)
        {
            ...
            float stepSize =Microsoft.Xna.Framework.MathHelper.Pi / topEdges;
        ...
        public static Vertices CreateGear(float radius, int numberOfTeeth, float tipPercentage, float toothHeight)
        {
            ...
            float stepSize =Microsoft.Xna.Framework.MathHelper.TwoPi / numberOfTeeth;
            tipPercentage /= 100f;
           Microsoft.Xna.Framework.MathHelper.Clamp(tipPercentage, 0f, 1f);
