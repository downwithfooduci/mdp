...
namespace FarseerPhysics.Common.PhysicsLogic
{
    ...
    public sealed class Explosion : PhysicsLogic
    {
        ...
        /// </summary>
        private const float MaxEdgeOffset =Microsoft.Xna.Framework.MathHelper.Pi / 90;
        ...
        /// </summary>
        public float MaxAngle =Microsoft.Xna.Framework.MathHelper.Pi / 15;
        ...
        public Dictionary<Fixture, List<FVector2>> Activate(FVector2 pos, float radius, float maxForce)
        {
            ...
            for (int i = 0; i < shapeCount; ++i)
            {
                ...
                if ((shapes[i].Body.BodyType == BodyType.Dynamic) && ps != null)
                {
                    ...
                    for (int j = 0; j < (ps.Vertices.Count()); ++j)
                    {
                        ...
                        diff = (diff -Microsoft.Xna.Framework.MathHelper.Pi) % (2 *Microsoft.Xna.Framework.MathHelper.Pi);
                        // the minus pi is important. It means cutoff for going other direction is at 180 deg where it needs to be

                        if (diff < 0.0f)
                            diff += 2 *Microsoft.Xna.Framework.MathHelper.Pi; // correction for not handling negs
            ...
            for (int i = 0; i < valIndex; ++i)
            {
                ...
                {
                    // the single edgecase
                    midpt = (vals[0] +Microsoft.Xna.Framework.MathHelper.Pi * 2 + vals[i]);
                }
                else
                {
                ...
                if ((hitClosest) && (shape.Body.BodyType == BodyType.Dynamic))
                {
                        ...
                        && (_data.Last().Max == _data.First().Min))
                    {
                        ...
                        {
                            fi.Min -=Microsoft.Xna.Framework.MathHelper.Pi * 2;
                            _data[0] = fi;
                        }
                    }
                    ...
                    {
                        last.Min = _data.Last().Min - 2 *Microsoft.Xna.Framework.MathHelper.Pi;
                        _data[lastPos] = last;
                    }
                    rayMissed = false;
                }
            ...
            for (int i = 0; i < _data.Count(); ++i)
            {
                ...
                float first = Microsoft.Xna.Framework.MathHelper.Min(MaxEdgeOffset, EdgeRatio * arclen);
                     ...
                     j += offset)
                {
                    ...
                    for (int x = 0; x < fl.Count; x++)
                    {
                        ...
                        float impulse = (arclen / (MinRays + insertedRays)) * maxForce * 180.0f /Microsoft.Xna.Framework.MathHelper.Pi *
            ...
            for (int i = 0; i < containedShapeCount; ++i)
            {
                ...
                float impulse = MinRays * maxForce * 180.0f /Microsoft.Xna.Framework.MathHelper.Pi;
                FVector2 hitPoint;
