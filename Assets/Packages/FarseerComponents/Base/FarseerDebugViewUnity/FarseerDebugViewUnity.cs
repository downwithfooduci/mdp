        ...
        private void DrawPerformanceGraph()
        {
            ...
            if (_graphValues.Count > 2)
            {
                ...
                for (int i = _graphValues.Count - 1; i > 0; i--)
                {
                    ...
                    FVector2 x1 = 
                        new FVector2(Microsoft.Xna.Framework.MathHelper.Clamp(x, PerformancePanelBounds.xMin, PerformancePanelBounds.xMax),
                                    Microsoft.Xna.Framework.MathHelper.Clamp(y1, PerformancePanelBounds.yMin, PerformancePanelBounds.yMax));

                    FVector2 x2 =
                        new FVector2(
                            Microsoft.Xna.Framework.MathHelper.Clamp(x + deltaX, PerformancePanelBounds.xMin, PerformancePanelBounds.xMax),
                            Microsoft.Xna.Framework.MathHelper.Clamp(y2, PerformancePanelBounds.yMin, PerformancePanelBounds.yMax));
