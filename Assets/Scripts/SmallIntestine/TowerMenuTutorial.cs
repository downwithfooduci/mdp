...
public class TowerMenuTutorial : MonoBehaviour {
	...
	void Start()
	{
		...
		m_Tower = gameObject.GetComponent<TowerTutorial>();
	...
	void LateUpdate()
	{
		if(!gameObject.GetComponent<TowerTutorial>().enabled)
			return;
