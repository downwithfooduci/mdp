...
public class IntestineGameManagerTutorial : MonoBehaviour 
{
	...
	private SpawnManagerTutorial spawnScript;
	...
	void Start()
	{
		...
		spawnScript = gameObject.GetComponent<SpawnManagerTutorial> ();
