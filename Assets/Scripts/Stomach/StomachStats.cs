...
public class StomachStats : MonoBehaviour
{
	// for drawing stars
	...
	private StomachLoadLevelCounter level;	//!< to hold a reference to the mouthloadlevelcounter script
	...
	void calculateStars()
	{
		if (timesCellDied == 0)			// if there were 0 coughs recorded the score is 5 stars
		{
			numStars = 5;
		} else if (timesCellDied == 1)	// if there was 1 cough recorded the score is 4 stars
		{
			numStars = 4;
		} else if (timesCellDied == 2)	// if there were 2 coughs recorded the score is 3 stars
		{
			numStars = 3;
		} else if (timesCellDied == 3)	// if there were 3 coughs recorded the score is 2 stars
		{
			numStars = 2;
